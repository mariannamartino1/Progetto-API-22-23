...
int main(){
    ...
    //TODO: finalizzare gli output in aggiungi/demolisci-stazione e aggiungi/rottama-auto, anche nei casi negativi in cui non esista la stazione o
    //      l'auto da rottamare
...
/* --- PIANIFICA-PERCORSO --- */
//Algoritmo di pianificazione del percorso considerando il numero minimo di tappe possibili e, se necessarie, quelle più vicine all'
